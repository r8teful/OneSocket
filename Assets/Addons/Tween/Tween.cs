...
namespace Pixelplacement {
    public class Tween
	{
		...
		static TweenSystem.TweenEngine _instance;
		#endregion
        ...
        /// <summary>
        /// Changes the named color property of a group of Renderers using a Material Property Block
        /// </summary>
        public static TweenSystem.TweenBase ShaderColorPropertyBlock(List<Renderer> renderers, MaterialPropertyBlock propertyBlock, string propertyName, Color endValue, float duration, float delay,  AnimationCurve easeCurve = null, LoopType loop = LoopType.None, Action startCallback = null, Action completeCallback = null, bool obeyTimescale = false)
        {
            TweenSystem.ShaderColor tween = new TweenSystem.ShaderColor(renderers, propertyBlock, propertyName, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
		...
		#region Public Properties - Ease Curves
		/// <summary>
		/// A linear curve.
		/// </summary>
